...
* Use [Cloudflare's WARP](https://1.1.1.1/) - a tool that helps you connect to more optimized network routes. This is a popular remedy especially for lower-end connections.
