...
<img className="mt-3" src="/images/importing-files/1.gif" alt="Importing files"/>
...
<img className="mt-3" src="/images/importing-files/2.gif" alt="Importing files via SFTP"/>